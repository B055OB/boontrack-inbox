...
export const DEFAULT_TENANT_CONFIGS: Record<string, TenantConfig> = {
  ...
  'onlineboost': {
    ...
    health: {
      status: 'HEALTHY',
      wa_gateway: 'CONNECTED',
      last_payment_ping: '1 menit lalu',
      last_activity_ping: 'Baru saja',
      response_time_ms: 120,
      uptime_pct: 99.9,
    },
    persona: {
      ai_name: 'OnlineBoost Course Consultant AI',
      system_prompt: 'Anda adalah asisten konsultan resmi OnlineBoost ID. Bantu calon pembeli memilih produk digital / ecourse unggulan (Strategi YouTube AI, Master Class Internet Marketing CPM, Ecourse Member CPM, dan Step by Step Paid Traffic Dollar) serta arahkan pembayaran cepat via QRIS.',
      tone: 'professional',
      greeting_message: 'Halo! Selamat datang di OnlineBoost ID 🚀 Siap meningkatkan pendapatan online Anda dengan produk ecourse digital kami hari ini?',
      fallback_message: 'Tim support OnlineBoost sedang menyiapkan detail materi untuk Anda, mohon tunggu sebentar ya!',
      human_handoff_enabled: true,
      human_handoff_number: '+6281224456454',
    },
    operational_hours: {
      days: ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'],
      open_time: '00:00',
      ...
      timezone: 'WIB',
      is_24_hours: true,
      closed_auto_reply: 'Terima kasih telah menghubungi OnlineBoost ID. Layanan akses digital kami aktif 24 jam.',
      emergency_contact: '+6281224456454',
    },
    pricing: {
      tier: 'PRO',
      monthly_fee: 499000,
      ...
      currency: 'IDR',
      custom_packages: [
        { id: 'OB-DIG-003', name: 'Ecourse Strategi YouTube AI: Metode Praktis Raih Pendapatan AdSense', price: 2999000, description: 'Metode Rahasia Simple dan Praktis dalam meraih Dollar dari Adsense hanya menggunakan AI' },
        { id: 'OB-DIG-004', name: 'Master Class Internet Marketing CPM', price: 9999999, description: 'Potensi Income CPM Organik Traffic Luar Negeri & Paid Traffic CPM' },
        { id: 'OB-DIG-005', name: 'Ecourse Member Internet Marketing CPM', price: 1490000, description: 'Lanjutan Basic Meraih Income di atas 500rb / Hari' },
        { id: 'OB-DIG-001', name: 'Step by Step Rahasia Menghasilkan Dollar dari Paid Traffic', price: 499000, description: 'Formula Hidden Gem menghasilkan dollar dari paid traffic' },
      ],
    },
    features: {
      whatsapp_gateway: true,
    ...
    secrets: {
      wa_api_token: 'EAAQ88910ZaBC290Kkl8890...',
      webhook_verify_token: 'onlineboost_verify_token_2026',
      payment_api_key: 'qris_live_sk_onlineboost_99',
      admin_password: 'onlineboost_pass2026',
    },
    updated_at: new Date().toISOString(),
  },
  'atmosfitnes': {
