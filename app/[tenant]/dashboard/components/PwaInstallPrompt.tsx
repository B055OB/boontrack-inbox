          ...
          <div className="bg-white rounded-3xl p-6 max-w-sm w-full border border-slate-200 shadow-2xl space-y-4 animate-in fade-in">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="text-sm font-black text-slate-900">Install ke Layar Utama</h4>
                  <p className="text-[11px] text-slate-500">Akses Cepat Layar Utama HP</p>
                </div>
              </div>
              <button
            ...
            <div className="space-y-2.5 text-xs text-slate-600 leading-relaxed bg-slate-50 p-4 rounded-2xl border border-slate-200/80">
              <div className="flex items-start gap-2">
                ...
                <p>Ketuk tombol <strong>Bagikan (Share)</strong> <Share className="w-3.5 h-3.5 inline mx-0.5 text-blue-600" /> di bilah browser (Safari / Chrome).</p>
              </div>
              <div className="flex items-start gap-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <p>Ketuk <strong>Tambah (Add)</strong>. Dashboard toko Anda kini siap dibuka seketika layaknya aplikasi resmi!</p>
              </div>
            </div>
