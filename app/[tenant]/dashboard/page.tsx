          ...
          <div className="relative flex-1 min-w-0 flex items-center">
            ...
            >
              ...
              {isProScale ? (
                ...
                <span className="px-1.5 py-0.5 bg-slate-100 text-slate-700 border border-slate-200 rounded text-[10px] font-extrabold shrink-0">
                  1 AGENT
                </span>
              )}
            </button>
            ...
            >
              ...
              <span className="whitespace-nowrap flex items-center gap-1">
                Broadcast WA Masal
                {!isProScale && <Lock className="w-3 h-3 text-amber-500 shrink-0" />}
              </span>
              {!isProScale ? (
                <span className="px-1.5 py-0.5 bg-amber-100 text-amber-800 border border-amber-200 rounded text-[10px] font-extrabold flex items-center gap-1 shrink-0">
                  <Lock className="w-2.5 h-2.5" /> PROSCALE
                </span>
              ) : (
                <span className="px-1.5 py-0.5 bg-emerald-100 text-emerald-800 border border-emerald-200 rounded text-[10px] font-extrabold shrink-0">
                  BLAST
